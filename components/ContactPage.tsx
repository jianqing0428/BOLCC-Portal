    ...
    <div className="bg-white p-8 sm:p-12 rounded-2xl shadow-lg max-w-4xl mx-auto border border-gray-100">
      ...
      <form action="#" method="POST" className="space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            <label htmlFor="first-name" className="sr-only">{t('contactPage.firstName')}</label>
            <input type="text" name="first-name" id="first-name" placeholder={t('contactPage.firstName')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" />
          </div>
          <div>
            <label htmlFor="last-name" className="sr-only">{t('contactPage.lastName')}</label>
            <input type="text" name="last-name" id="last-name" placeholder={t('contactPage.lastName')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" />
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            <label htmlFor="email" className="sr-only">{t('contactPage.emailAddress')}</label>
            <input type="email" name="email" id="email" placeholder={t('contactPage.emailAddress')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" />
          </div>
          <div>
            <label htmlFor="phone" className="sr-only">{t('contactPage.phoneNumber')}</label>
            <input type="tel" name="phone" id="phone" placeholder={t('contactPage.phoneNumber')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" />
          </div>
        </div>
        <div>
          <label htmlFor="message" className="sr-only">{t('contactPage.message')}</label>
          <textarea name="message" id="message" rows={6} placeholder={t('contactPage.message')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500"></textarea>
        </div>
  ...
  return (
    <div className="bg-white p-8 sm:p-12 rounded-2xl shadow-lg max-w-4xl mx-auto border border-gray-100">
      ...
      <form action="#" method="POST" className="space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            <label htmlFor="prayer-first-name" className="sr-only">{t('contactPage.firstNameOptional')}</label>
            <input type="text" name="prayer-first-name" id="prayer-first-name" placeholder={t('contactPage.firstNameOptional')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" />
          </div>
          <div>
            <label htmlFor="prayer-last-name" className="sr-only">{t('contactPage.lastNameOptional')}</label>
            <input type="text" name="prayer-last-name" id="prayer-last-name" placeholder={t('contactPage.lastNameOptional')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" />
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            <label htmlFor="prayer-email" className="sr-only">{t('contactPage.emailAddressOptional')}</label>
            <input type="email" name="prayer-email" id="prayer-email" placeholder={t('contactPage.emailAddressOptional')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" />
          </div>
          <div>
            <label htmlFor="prayer-phone" className="sr-only">{t('contactPage.phoneNumberOptional')}</label>
            <input type="tel" name="prayer-phone" id="prayer-phone" placeholder={t('contactPage.phoneNumberOptional')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" />
          </div>
        </div>
        <div>
          <label htmlFor="prayer-message" className="sr-only">{t('contactPage.prayerMessagePlaceholder')}</label>
          <textarea name="prayer-message" id="prayer-message" rows={6} placeholder={t('contactPage.prayerMessagePlaceholder')} className="w-full bg-gray-100 border-gray-200 rounded-lg p-4 text-sm focus:ring-blue-500 focus:border-blue-500" required></textarea>
        </div>
        <div>
          <button type="submit" className="w-full sm:w-auto bg-gray-900 text-white font-bold py-4 px-8 rounded-lg hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">
